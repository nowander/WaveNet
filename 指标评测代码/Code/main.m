...
for d = 1:datasetNum
    ...
    for m = 1:modelNum
        ...
        fprintf(fileID, '(Dataset:%s; Model:%s) Smeasure:%.3f; MAE:%.4f; adpEm:%.3f; meanEm:%.3f; maxEm:%.3f; adpFm:%.3f; meanFm:%.3f; maxFm:%.3f.\n',dataset,model,Smeasure, mae, adpEm, meanEm, maxEm, adpFm, meanFm, maxFm);  
        fprintf('(Dataset:%s; Model:%s) Smeasure:%.3f; MAE:%.4f; adpEm:%.3f; meanEm:%.3f; maxEm:%.3f; adpFm:%.3f; meanFm:%.3f; maxFm:%.3f.\n',dataset,model,Smeasure, mae, adpEm, meanEm, maxEm, adpFm, meanFm, maxFm);  
